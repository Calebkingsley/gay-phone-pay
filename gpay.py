...
caleb=gp.Google_pay("8754554295","caleb kingsley")
caleb.open_gpay()
caleb.mobile_verification()
caleb.name_verification()
caleb.otp_verification(76564,76564)
caleb.PanCard_Verification()

caleb.Bank_verification()

caleb.set_Pin("9874")
caleb.Enter_your_Pin(7890,7890)

class Phone_pe(gp.Google_pay):                                                                                          
    def __init__(self,Phone_number,Name):
        super().__init__(Phone_number,Name)

    def open_phonepe(self):
        print("Phone pay")
        
kingsley=Phone_pe("8754554295","caleb kingsley")
kingsley.open_phonepe()
kingsley.mobile_verification()
kingsley.name_verification()
kingsley.otp_verification(345678,345678)
kingsley.Bank_verification()
kingsley.PanCard_Verification()
kingsley.set_Pin("9874")
kingsley.Enter_your_Pin(7890,7890)


        
googlepay=[{"name":"abishek","gpaynum":9936304497,"type":"personal","transaction":"regular"},                       
           {"name":"abinaya mam","gpaynum":7305341565,"type":"personal","transaction":"regular"},
           {"name":"abinesh","gpaynum":6381347949,"type":"personal","transaction":"rare"},
           {"name":"Abishek football","gpaynum":7358355054,"type":"personal","transaction":"never"},
           {"name":"ajay","gpaynum":7200636126,"type":"personal","transaction":"rare"},
           {"name":"aditiya","gpaynum":9597916931,"type":"personal","transaction":"rare"},
           {"name":"ahmed","gpaynum":8056469214,"type":"personal","transaction":"regular"},
           {"name":"agent akash ","gpaynum":9962454833,"type":"personal","transaction":"rare"},
           {"name":"appa","gpaynum":8015341851,"type":"personal","transaction":"rare"},
           {"name":"aswin rijo","gpaynum":7305624091,"type":"personal","transaction":"rare"},
           {"name":"bala","gpaynum":8939509826,"type":"personal","transaction":"rare"},
           {"name":"bercial","gpaynum":6369121983,"type":"personal","transaction":"regular"},
           {"name":"barath","gpaynum":9833807044,"type":"personal","transaction":"regular"},
           {"name":"bhuvanesh","gpaynum":9941297487,"type":"personal","transaction":"rare"},
           {"name":"bharath disys","gpaynum":7200001990,"type":"personal","transaction":"regular"},
           ...
           {"name":"bryan","gpaynum":9500075619,"type":"personal","transaction":"rare"},
           {"name":"chitti","gpaynum":8072512570,"type":"personal","transaction":"regular"},
           {"name":"damodharan","gpaynum":6382761961,"type":"personal","transaction":"rare"},
           {"name":"dhanuskodi","gpaynum":9791045340,"type":"personal","transaction":"regular"},
           {"name":"dinesh","gpaynum":9841032642,"type":"personal","transaction":"regular"},
           {"name":"emimal","gpaynum":6383908036,"type":"personal","transaction":"regular"},
